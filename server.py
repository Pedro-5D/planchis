...
ALLOWED_ORIGINS = ['*']  # Para producción, puedes restringirlo a dominios específicos, ej: ['https://izarren.top', 'https://www.izarren.top']
...
async def main():
    # Usar variables de entorno si están disponibles (para despliegue en plataformas como Render)
    import os
    
    host = os.environ.get('HOST', '0.0.0.0')  # Escuchar en todas las interfaces
    ...
    async with websockets.serve(
        ...
        host, 
        port,
        ping_interval=30,        # Mantener conexiones activas
        ping_timeout=10,
        max_size=1024*1024,      # Permitir mensajes más grandes (1MB)
        max_queue=32             # Cola de mensajes más grande
    ):
