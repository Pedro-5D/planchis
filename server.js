...
server.listen(PORT, '0.0.0.0', () => {
  console.log('\n=======================================');
  console.log('  SERVIDOR PLANCHÍS - MODO RED LOCAL');
  console.log('=======================================\n');
  ...
  if (!addressFound) {
    console.log('  No se encontraron direcciones de red. ¿Estás conectado a una red?');
    console.log('  Prueba usar solo: http://localhost:3000');
  }
